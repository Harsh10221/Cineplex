      ...
      <div className="max-w-7xl p-5 mx-auto">
        <div className="flex flex-col sm:flex-row justify-between border-b border-white/10 pb-8">
          <div className="mb-8 sm:mb-0 w-full sm:w-1/2 lg:w-1/4">
            <h3 className="text-lg text-white font-bold tracking-wide mb-4">
              Support
            </h3>
        ...
        <div className="py-8 border-b border-white/10">
          ...
          <div className="flex space-x-4">
            <div className="bg-white p-2 rounded-full w-9 h-9 hover:bg-gray-200 transition-colors cursor-pointer text-black font-bold flex items-center justify-center text-xs">
              FB
            </div>
            <div className="bg-white p-2 rounded-full w-9 h-9 hover:bg-gray-200 transition-colors cursor-pointer text-black font-bold flex items-center justify-center text-xs">
              TW
...
function DateSelector() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white font-sans flex flex-col">
      {/* 1. FIXED NAVBAR */}
        ...
        <div className=" grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 mb-8 border-b border-white/10 pb-8">
          <div className=" flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-3 text-sm md:text-base text-gray-300 font-medium">
              ...
              <span className="text-gray-400">{matchedData?.genres}</span>

              {/* Separator */}
              <span className="hidden sm:inline-block text-gray-600">•</span>

              {/* Duration */}
              <span className="text-white font-semibold">{timeformater()}</span>
            </div>
          </div>
